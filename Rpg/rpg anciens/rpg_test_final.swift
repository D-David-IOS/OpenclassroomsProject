class Game{
        ...
        if j == 1{
            if let number = readLine(){
                ...
                if let numero = readLine(){
                        switch numero {
                            case "1" :
                                array_player2_team[i] = Legionnary.init()
                            case "2" :
                                array_player2_team[i] = Barbaric.init()
                            case "3" :
    ...
    // choice et le numéro du personnage sémectionné
    ...
    var hp = 50 {
        ...
        didSet{
            if hp <= 0{
                ...
                print("")
                print("Le personnage \(name) à perdu \(abs(hp - oldValue)) hp ! il lui reste \(hp) hp")
                print("")
            }
        }
    }
